...
bool appointment::layout(gui::page& persistent_page, gui::page& home_page, std::string& error)
{
	...
	appointment_list.columns = {
		...
		app_state_.column_details("Time", 80 , widgets::listview_column_type::string_ , color {0, 0 , 0}),
		app_state_.column_details("Date", 80 , widgets::listview_column_type::string_, color {0, 0 , 0}),
